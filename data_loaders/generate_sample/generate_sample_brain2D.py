...
def main():
    ...
    tf_file_name = '/home/haoliang/Downloads/datasets/Brain_img/2D/'#validation/validation-00000-of-00060'
    ...
    train_iterator, test_iterator ,_= \
             get_data(sess, tf_file_name,2, 1, 1, 1, 128,
                    128, 128, 96, False)
    ...
    img = Image.fromarray((IMG_p[1][:,:,0]   ) *255)
    img.show()
